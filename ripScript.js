...
/** @type {[{imageURL: string, backgroundGradientColors: [[number, number, number],[number, number, number]]}]} */
...
for (const img of customImages) {
  images.push({
    texture: textureLoader.load(img.imageURL),
    colors: img.backgroundGradientColors
  })
}
